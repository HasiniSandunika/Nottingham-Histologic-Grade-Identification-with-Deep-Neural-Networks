...
print("Three Predict Model Implementation")
...
create_numpy('/three_predict_model/dataset/train_data', '/three_predict_model/numpy', 'train', 74) 

## create numpy arrays for testing dataset from processed images
create_numpy('/three_predict_model/dataset/test_data', '/three_predict_model/numpy', 'test', 73) 

## split training dataset for training and validation
x_train_rgb = np.load('/three_predict_model/numpy/x_train.npy')
y_train_rgb = np.load('/three_predict_model/numpy/y_train.npy')
...
filepath='/three_predict_model/models/weights30.h5'
...
model.save('/three_predict_model/models/model.h5')
...
model = load_model('/three_predict_model/models/weights30.h5')
model.summary()
